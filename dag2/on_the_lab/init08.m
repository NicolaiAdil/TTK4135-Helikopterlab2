...
lab_day = 2; %For example 1,2,3,4
test_condition = 'open_loop_controller_test_different_start_pitch_-10_degrees'; %Descpritive of what we're doing
...
save(file_name, 'time', 'travel', 'travel_rate', 'pitch', 'pitch_rate', 'elevation', 'elevation_rate', 'pitch_reference', 'elevation_reference', 'V_d', 'V_s');
