 ...
 * C source code generated on : Wed Jan 31 12:28:28 2024
 *
...
void helicopter_output(void)
{
  ...
  if (rtmIsMajorTimeStep(helicopter_M)) {
     ...
     */
    helicopter_B.Gain1 = helicopter_P.Gain1_Gain * helicopter_P.pitch_ref_Value;
  }
   ...
   *  Sum: '<S7>/Sum3'
   */
  rtb_Clock = ((helicopter_B.Gain1 - helicopter_P.Gain1_Gain_f *
  ...
  if (rtmIsMajorTimeStep(helicopter_M)) {
     ...
     */
    helicopter_B.Gain1_k = helicopter_P.Gain1_Gain_i *
   ...
   *  Gain: '<S2>/Gain1'
   */
  rtb_Derivative = helicopter_B.Gain1_k - helicopter_P.Gain1_Gain_f *
    helicopter_B.Sum;
  ...
  rtb_Backgain = ((helicopter_P.K_ep * rtb_Derivative +
                  ...
                  helicopter_B.Gain_d * helicopter_P.K_ed) + helicopter_P.Vs_ff;
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (98251222U);
  helicopter_M->Sizes.checksums[1] = (268218911U);
  helicopter_M->Sizes.checksums[2] = (863119117U);
  helicopter_M->Sizes.checksums[3] = (1174022434U);
