  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% helicopter_P.pitch_offset_Value
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% helicopter_B.pitchandelevationreference
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.Elevationrate_PWORK.LoggedData
	  ...
	  ;% helicopter_DW.Elevationreference_PWORK.LoggedData
	  ...
	  ;% helicopter_DW.ToWorkspace5_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 24;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_DW.ToWorkspace7_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 25;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_DW.ToWorkspace8_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 26;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_DW.x_1_PWORK.TimePtr
	  section.data(13).logicalSrcIdx = 27;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_DW.x_2_PWORK.TimePtr
	  section.data(14).logicalSrcIdx = 28;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_DW.x_3_PWORK.TimePtr
	  section.data(15).logicalSrcIdx = 29;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_DW.x_4_PWORK.TimePtr
	  section.data(16).logicalSrcIdx = 30;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_DW.x_5_PWORK.TimePtr
	  section.data(17).logicalSrcIdx = 31;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_DW.x_41_PWORK.TimePtr
	  section.data(18).logicalSrcIdx = 32;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_DW.ToWorkspace9_PWORK.LoggedData
	  section.data(19).logicalSrcIdx = 33;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_DW.ToWorkspace10_PWORK.LoggedData
	  section.data(20).logicalSrcIdx = 34;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_DW.ToWorkspace6_PWORK.LoggedData
	  ...
	  ;% helicopter_DW.Pitchrate_PWORK.LoggedData
	  section.data(23).logicalSrcIdx = 37;
	  section.data(23).dtTransOffset = 22;
	
	  ;% helicopter_DW.Pitchreference_PWORK.LoggedData
	  ...
	  ;% helicopter_DW.ToWorkspace_PWORK_l.LoggedData
	  ...
	  ;% helicopter_DW.V_d_PWORK.LoggedData
	  section.data(29).logicalSrcIdx = 43;
	  section.data(29).dtTransOffset = 28;
	
	  ;% helicopter_DW.V_s_PWORK.LoggedData
	  ...
	  ;% helicopter_DW.x_1_IWORK.PrevIndex
	  section.data(2).logicalSrcIdx = 64;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_DW.x_2_IWORK.PrevIndex
	  section.data(3).logicalSrcIdx = 65;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_DW.x_3_IWORK.PrevIndex
	  section.data(4).logicalSrcIdx = 66;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_DW.x_4_IWORK.PrevIndex
	  section.data(5).logicalSrcIdx = 67;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helicopter_DW.x_5_IWORK.PrevIndex
	  section.data(6).logicalSrcIdx = 68;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helicopter_DW.x_41_IWORK.PrevIndex
  ...
  targMap.checksum0 = 3757349029;
  targMap.checksum1 = 1520086219;
  targMap.checksum2 = 3188959602;
  targMap.checksum3 = 4067442171;
